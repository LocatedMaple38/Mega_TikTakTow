...
void mousePressed() {
  ...
  if (start == true) {
    ...
    if(bottomCenterActive == true && topLeft8OverRide == false && teamGoing == true && mouseX> && mouseX<+ && mouseY> && mouseY<+){
      topLeft8X = true;
    ...
    if(bottomCenterActive == true && topCenter8OverRide == false && teamGoing == true && mouseX> && mouseX<+ && mouseY> && mouseY<+){
      topCenter8X = true;
